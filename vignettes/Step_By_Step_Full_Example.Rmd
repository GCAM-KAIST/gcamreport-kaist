...
**Note**: You can do this step-by-step example using the provided [GCAM7.0 database](https://zenodo.org/records/10258919) or your own database! Remember to indicate the `GCAM_version` when generating the report ;)
...
**Note**: You can do this step-by-step example using the provided `example2_v7.0.dat` project or any project generated through your own database! Remember to indicate the `GCAM_version` when generating the report ;)
...
**Note**: You can do this step-by-step example using the provided `example3_v7.0.RData` file or any file generated through your own database! Remember to indicate the `GCAM_version` when generating the report ;)
