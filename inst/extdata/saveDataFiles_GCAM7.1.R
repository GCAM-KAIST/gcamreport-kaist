...
co2_resource_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1", "CO2_resource_map.csv"),
                                  skip = 1, na = "",
                                  stringsAsFactors = FALSE
) %>% gather_map()
...
food_intake_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1", "food_intake_map.csv"),
                              skip = 1,
                              stringsAsFactors = FALSE
) %>% gather_map()
...
en_demand_price_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1", "en_demand_price_map.csv"),
                                  skip = 1,
                                  stringsAsFactors = FALSE
)
...
energy_price_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1", "en_price_map.csv"),
                                   skip = 1, na = "",
                                   stringsAsFactors = FALSE
) %>% gather_map()
...
res_extraction_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1", "res_extraction_map.csv"),
                                skip = 1,
                                stringsAsFactors = FALSE
) %>% gather_map()
...
transport_sales_map_v7.1 <- read.csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.1",
...
# Read in template
template_v7.1 <- readxl::read_excel(file.path(rawDataFolder, "inst/extdata", "template/GCAM7.1/common-definitions-template.xlsx"),
                                 sheet = 'variable'
) %>%
