...
cf_rgn_v7.0 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.0", "L223.StubTechCapFactor_elec.csv"),
  ...
  bind_rows(
    tibble::tibble(
      region = rep(c("South Korea", "Russia"), each = 22),
      supplysector = "electricity",
      subsector = "nuclear",
      stub.technology = "Gen_III_Korea",
      year = rep(c(1975, 1990, 2005, 2010, 2015, 2020, 2025, 2030, 2035, 2040, 2045, 2050, 2055, 2060, 2065, 2070, 2075, 2080, 2085, 2090, 2095, 2100), 2),
      capacity.factor = 0.9
    )
)
