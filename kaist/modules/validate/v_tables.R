...
step5_exceptions <- tribble(
  ...
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy$",                        "korea", "scaled",      "b1",    "exists", "intl bunkers removed (years >= 2020)",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy\\|Demand$",               "korea", "scaled",      "b1",    "none",   "",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy\\|Demand\\|Transportation$", "korea", "scaled",   "b1",    "none",   "",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy\\|Demand\\|Transportation\\|Domestic (Aviation|Shipping)$", "korea", "scaled", "b1", "none", "",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy\\|Demand\\|Bunkers",      "korea", "scaled",      "b1",    "none",   "",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)$",                                 "korea", "scaled",      "b1",    "none",   "gas totals: intl bunkers removed",
  "^Emissions\\|(CO2|N2O|CH4|Kyoto Gases)\\|Energy and Industrial Processes$", "korea", "scaled",    "b1",    "none",   "",
...
step5_relations <- tribble(
  ...
  "co2_top",           "step1;step2_all;step2_korea",  "Emissions|CO2",                                  "Emissions|CO2|Energy;Emissions|CO2|Industrial Processes;Emissions|CO2|AFOLU;Emissions|CO2|Other;Emissions|CO2|Other Capture and Removal",
  "co2_eip",           "step1;step2_all;step2_korea",  "Emissions|CO2|Energy and Industrial Processes",  "Emissions|CO2|Energy;Emissions|CO2|Industrial Processes",
