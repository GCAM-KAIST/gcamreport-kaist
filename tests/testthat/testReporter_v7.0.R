...
generate_report(
  ...
  desired_variables = available_variables(F, GCAM_version = 'v7.0')[c(1, 3, 10, 11)],
  launch_ui = FALSE,
  GCAM_version = 'v7.0'
)
testResult_variables = unique(report$Variable)
save(testResult_variables, file = file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_7.0/result_test7.2.RData"))
testResult_variables <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_7.0/result_test7.2.RData")))
...
testResult_variables = unique(report$Variable)
save(testResult_variables, file = file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_7.0/result_test7.3.RData"))
...
testthat::expect_equal(unique(report$Model), 'GCAM 7.0')
  ...
  generate_report(
    ...
    final_year = 2050,
    desired_regions = "USA",
    desired_variables = c("Price|Carbon","GDP*"),
    launch_ui = FALSE,
    save_output = FALSE,
    GCAM_version = 'v7.0'
  )
...
test_that("Test12v_7.0 other functions", {
  ...
  testthat::expect_equal(co2_tech_map, gcamreport::co2_tech_map_v7.0)
